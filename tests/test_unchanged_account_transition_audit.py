...
from modules.canonical_history import canonical_source, current_commit, current_object, object_at_height
...
def test_unchanged_alice_across_other_account_commits(tmp_path, monkeypatch):
    ...
    for height, other in enumerate(others, start=1):
        ...
        print(
            ...
            f"current_object=missing X_current_verify=no X_height0_verify=yes "
